...
function Footer() {
  ...
  return (
    <Container maxWidth="md" className={classes.footerPadding}>
            ...
            <Box display="flex" flexGrow={2} flexDirection="column">
              <Box p={1} fontWeight="fontWeightBold">
                <svg fill="none" height="23" width="66">
                  <path
                    d="M44.87 17.272a4.318 4.318 0 11.04-4.877l3.191-1.884a8.019 8.019 0 10-.017 8.613l-3.213-1.852zM53.662 0H49.96v22.206h3.7v-7.402a4.318 4.318 0 118.636 0v7.402h3.701v-8.122a7.3 7.3 0 00-12.336-5.282V0zM27.756 0h-3.701v17.271a5.551 5.551 0 009.201 4.183l-1.788-3.034a1.847 1.847 0 01-1.45.701h-.412a1.851 1.851 0 01-1.85-1.85v-6.168h3.7V7.402h-3.7V0zM19.74 0a2.056 2.056 0 100 4.112 2.056 2.056 0 000-4.112zM21.59 22.206V7.402h-3.7v14.804h3.7z"
                    fill="currentColor"
                  ></path>
                  <path
                    clipRule="evenodd"
                    d="M0 22.206h3.7v-4.318h3.393A8.944 8.944 0 107.093 0H0v22.206zM3.7 3.7h3.393a5.243 5.243 0 010 10.486H3.701V3.7z"
                    fillRule="evenodd"
                    fill="currentColor"
                  ></path>
                </svg>
              </Box>
              <Box p={1}>© Copyright 2020 Pitch Software GmbH.</Box>
              <Box p={1}>All rights reserved.</Box>
            </Box>
          </Grid>
            ...
            <Box display="flex" justifyContent="space-around" flexWrap="wrap">
              ...
              <Box flexBasis="6.69625rem">
                <Box display="flex" flexDirection="column">
                  ...
                  <Box p={1}>Terms of Use</Box>
                  <Box p={1}>DPA</Box>
                  <Box p={1}>ERDF Support</Box>
                </Box>
              </Box>
                ...
                <Box display="flex" flexDirection="column" alignItems="stretch">
                  ...
                  >
                    ...
                    <Box p={1}>
                      ...
                      >
                        <path
                          d="m1.324.00097656c-.731 0-1.324.59296344-1.324 1.32392344v21.3507c0 .7319.593 1.3239 1.324 1.3239h11.676v-8.9994h-3v-2.9999h3v-1.9998c0-3.09884 2.235-4.99973 5-4.99973 1.325 0 2.168-.044 2.5 0l-.5 2.99982h-2c-1.5 0-2 .94994-2 1.99991v1.9998h4.273l-.773 2.9999h-3.5v8.9994h6.675c.733 0 1.325-.592 1.325-1.3239v-21.3507c0-.73096-.592-1.32392344-1.324-1.32392344z"
                          fill="#424648"
                        />
                      </svg>
                    </Box>
                    ...
                    <Box p={1}>
                      ...
                      >
                        <path
                          d="m20.4 20.4h-3.6v-6.36c0-.996-.804-1.8-1.8-1.8s-1.8.804-1.8 1.8v6.36h-3.6v-10.8h3.6v1.44c.6-1.008 1.908-1.68 3-1.68 2.316 0 4.2 1.884 4.2 4.2zm-15-12.828c-1.2 0-2.172-.972-2.172-2.172s.972-2.172 2.172-2.172 2.172.972 2.172 2.172-.972 2.172-2.172 2.172zm1.8 12.828h-3.6v-10.8h3.6zm14.4-20.4h-19.2c-1.332 0-2.4 1.068-2.4 2.4v19.2c0 1.32 1.08 2.4 2.4 2.4h19.2c1.32 0 2.4-1.08 2.4-2.4v-19.2c0-1.332-1.08-2.4-2.4-2.4z"
                          fill="#424648"
                        />
                      </svg>
                    </Box>
